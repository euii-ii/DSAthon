...
export default function ModernTimeline() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-500 via-blue-500 to-green-500 animate-gradient text-green-900 py-20 px-6">
        ...
        {timelineEvents.map((event, index) => (
          ...
          >
            <div className="flex items-center gap-8">
              <div className="hidden md:flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-green-500 to-blue-700 shadow-lg shadow-green-500/20">
